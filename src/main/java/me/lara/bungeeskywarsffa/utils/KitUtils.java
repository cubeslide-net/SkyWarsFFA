...
public class KitUtils {
    ...
    public static void giveBasicKit(Player player) {
        ...
        player.getInventory().setItem(0, ItemBuilder.buildItem(Material.NETHERITE_SWORD, 1, "§3§lDiamond Sword", Arrays.asList(""), true));
        ...
        player.getInventory().setItem(3, ItemBuilder.buildItem(Material.COBBLESTONE, 32, "§eCobblestone", Arrays.asList("", "§eCobblestone"), false));
